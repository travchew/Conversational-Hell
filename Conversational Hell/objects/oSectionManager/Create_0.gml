...
function check_cutsc_d25good() {
	with(oCutscManager) {
		...
		cutsc("d25good2", 4*SEC, true, dialogue_date, [enki_lore10, 3, 5, 3]);
...
function check_cutsc_d25bad() {
	with(oCutscManager) {
		...
		cutsc("d25bad3", 2*SEC, true, dialogue_protagonist, [d25bad2, 10, 2, 4, 2, 2]);
		cutsc("d25bad4", 7.5*SEC, true, dialogue_date, [d25bad4, 3, 1, 2]);
		cutsc("d25good5", 2*SEC, true, dialogue_protagonist, [d25bad5, 10, 2, 2, 2, 3]);
		cutsc("go to enki SNAPS", 3, true, prompt_goto_section, ["enki_snaps"]);
	}
}
